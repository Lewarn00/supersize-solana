...
//     const providerEphemeralRollup = useMemo(() =>
//         useRef<anchor.AnchorProvider>(
//             fastestEndpoint ? new anchor.AnchorProvider(
//                 new anchor.web3.Connection(fastestEndpoint, {
//                     wsEndpoint: fastestEndpoint.replace("https", "wss"),
//                 }),
//                 new NodeWallet(wallet)
//             ) :
//                 new anchor.AnchorProvider(
//                     new anchor.web3.Connection("https://supersize.magicblock.app", { wsEndpoint: "wss://supersize.magicblock.app" }),
//                     new NodeWallet(wallet))
//         ), [wallet, fastestEndpoint]);
